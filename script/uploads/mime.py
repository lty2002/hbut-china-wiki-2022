mapper = {'123': 'application/vnd.lotus-1-2-3', '3dml': 'text/vnd.in3d.3dml', '3ds': 'image/x-3ds',
          '3g2': 'video/3gpp2',
          '3gp': 'video/3gpp', '7z': 'application/x-7z-compressed', 'aab': 'application/x-authorware-bin',
          'aac': 'audio/x-aac',
          'aam': 'application/x-authorware-map', 'aas': 'application/x-authorware-seg', 'abs': 'audio/x-mpeg',
          'abw': 'application/x-abiword', 'ac': 'application/pkix-attr-cert',
          ...
          'aif': 'audio/x-aiff', 'aifc': 'audio/x-aiff', 'aiff': 'audio/x-aiff', 'aim': 'application/x-aim',
          'air': 'application/vnd.adobe.air-application-installer-package+zip', 'ait': 'application/vnd.dvb.ait',
          'ami': 'application/vnd.amiga.ami', 'anx': 'application/annodex',
          'apk': 'application/vnd.android.package-archive',
          'appcache': 'text/cache-manifest', 'application': 'application/x-ms-application',
          'apr': 'application/vnd.lotus-approach', 'arc': 'application/x-freearc', 'art': 'image/x-jg',
          'asc': 'application/pgp-signature', 'asf': 'video/x-ms-asf', 'asm': 'text/x-asm',
          'aso': 'application/vnd.accpac.simply.aso', 'asx': 'video/x-ms-asf', 'atc': 'application/vnd.acucorp',
          'atom': 'application/atom+xml', 'atomcat': 'application/atomcat+xml', 'atomsvc': 'application/atomsvc+xml',
          'atx': 'application/vnd.antix.game-component', 'au': 'audio/basic', 'avi': 'video/x-msvideo',
          'avx': 'video/x-rad-screenplay', 'aw': 'application/applixware', 'axa': 'audio/annodex',
          'axv': 'video/annodex',
          'azf': 'application/vnd.airzip.filesecure.azf', 'azs': 'application/vnd.airzip.filesecure.azs',
          'azw': 'application/vnd.amazon.ebook', 'bat': 'application/x-msdownload', 'bcpio': 'application/x-bcpio',
          ...
          'blorb': 'application/x-blorb', 'bmi': 'application/vnd.bmi', 'bmp': 'image/bmp', 'body': 'text/html',
          ...
          'c': 'text/x-c', 'c11amc': 'application/vnd.cluetrust.cartomobile-config',
          'c11amz': 'application/vnd.cluetrust.cartomobile-config-pkg', 'c4d': 'application/vnd.clonk.c4group',
          'c4f': 'application/vnd.clonk.c4group', 'c4g': 'application/vnd.clonk.c4group',
          'c4p': 'application/vnd.clonk.c4group',
          'c4u': 'application/vnd.clonk.c4group', 'cab': 'application/vnd.ms-cab-compressed', 'caf': 'audio/x-caf',
          'cap': 'application/vnd.tcpdump.pcap', 'car': 'application/vnd.curl.car',
          'cat': 'application/vnd.ms-pki.seccat',
          'cb7': 'application/x-cbr', 'cba': 'application/x-cbr', 'cbr': 'application/x-cbr',
          ...
          'cdmio': 'application/cdmi-object', 'cdmiq': 'application/cdmi-queue', 'cdx': 'chemical/x-cdx',
          'cdxml': 'application/vnd.chemdraw+xml', 'cdy': 'application/vnd.cinderella', 'cer': 'application/pkix-cert',
          'cfs': 'application/x-cfs-compressed', 'cgm': 'image/cgm', 'chat': 'application/x-chat',
          'chm': 'application/vnd.ms-htmlhelp', 'chrt': 'application/vnd.kde.kchart', 'cif': 'chemical/x-cif',
          'cii': 'application/vnd.anser-web-certificate-issue-initiation', 'cil': 'application/vnd.ms-artgalry',
          'cla': 'application/vnd.claymore', 'class': 'application/java',
          ...
          'cxx': 'text/x-c', 'dae': 'model/vnd.collada+xml', 'daf': 'application/vnd.mobius.daf',
          ...
          'dgc': 'application/x-dgc-compressed', 'dib': 'image/bmp', 'dic': 'text/x-c', 'dir': 'application/x-director',
          ...
          'dmg': 'application/x-apple-diskimage', 'dmp': 'application/vnd.tcpdump.pcap',
          ...
          'dpg': 'application/vnd.dpgraph', 'dra': 'audio/vnd.dra', 'dsc': 'text/prs.lines.tag',
          'dssc': 'application/dssc+der',
          'dtb': 'application/x-dtbook+xml', 'dtd': 'application/xml-dtd', 'dts': 'audio/vnd.dts',
          'dtshd': 'audio/vnd.dts.hd',
          'dump': 'application/octet-stream', 'dv': 'video/x-dv', 'dvb': 'video/vnd.dvb.file',
          ...
          'evy': 'application/x-envoy', 'exe': 'application/octet-stream', 'exi': 'application/exi',
          ...
          'fig': 'application/x-xfig', 'flac': 'audio/flac', 'fli': 'video/x-fli',
          'flo': 'application/vnd.micrografx.flo',
          'flv': 'video/x-flv', 'flw': 'application/vnd.kde.kivio', 'flx': 'text/vnd.fmi.flexstor',
          'fly': 'text/vnd.fly',
          'fm': 'application/vnd.framemaker', 'fnc': 'application/vnd.frogans.fnc', 'for': 'text/x-fortran',
          'fpx': 'image/vnd.fpx', 'df': 'application/vnd.framemaker', 'fsc': 'application/vnd.fsc.weblaunch',
          ...
          'gv': 'text/vnd.graphviz', 'gxf': 'application/gxf', 'gxt': 'application/vnd.geonext',
          'gz': 'application/x-gzip',
          'h': 'text/x-c', 'h261': 'video/h261', 'h263': 'video/h263', 'h264': 'video/h264',
          ...
          'hqx': 'application/mac-binhex40', 'htc': 'text/x-component', 'htke': 'application/vnd.kenameaapp',
          'htm': 'text/html',
          'html': 'text/html', 'hvd': 'application/vnd.yamaha.hv-dic', 'hvp': 'application/vnd.yamaha.hv-voice',
          'hvs': 'application/vnd.yamaha.hv-script', 'i2g': 'application/vnd.intergeo',
          'icc': 'application/vnd.iccprofile',
          'ice': 'x-conference/x-cooltalk', 'icm': 'application/vnd.iccprofile', 'ico': 'image/x-icon',
          'ics': 'text/calendar',
          ...
          'ivu': 'application/vnd.immervision-ivu', 'jad': 'text/vnd.sun.j2me.app-descriptor',
          ...
          'jpm': 'video/jpm', 'js': 'application/javascript', 'jsf': 'text/plain', 'json': 'application/json',
          'jsonml': 'application/jsonml+json', 'jspf': 'text/plain', 'kar': 'audio/midi',
          ...
          'kne': 'application/vnd.kinar', 'knp': 'application/vnd.kinar', 'kon': 'application/vnd.kde.kontour',
          ...
          'lwp': 'application/vnd.lotus-wordpro', 'lzh': 'application/x-lzh-compressed',
          ...
          'm4a': 'audio/mp4', 'm4b': 'audio/mp4', 'm4r': 'audio/mp4', 'm4u': 'video/vnd.mpegurl', 'm4v': 'video/mp4',
          'ma': 'application/mathematica', 'mac': 'image/x-macpaint', 'mads': 'application/mads+xml',
          ...
          'mgz': 'application/vnd.proteus.magazine', 'mid': 'audio/midi', 'midi': 'audio/midi',
          'mie': 'application/x-mie',
          'mif': 'application/x-mif', 'mime': 'message/rfc822', 'mj2': 'video/mj2', 'mjp2': 'video/mj2',
          ...
          'movie': 'video/x-sgi-movie', 'mp1': 'audio/mpeg', 'mp2': 'audio/mpeg', 'mp21': 'application/mp21',
          'mp2a': 'audio/mpeg', 'mp3': 'audio/mpeg', 'mp4': 'video/mp4', 'mp4a': 'audio/mp4', 'mp4s': 'application/mp4',
          'mp4v': 'video/mp4', 'mpa': 'audio/mpeg', 'mpc': 'application/vnd.mophun.certificate', 'mpe': 'video/mpeg',
          'mpeg': 'video/mpeg', 'mpega': 'audio/x-mpeg', 'mpg': 'video/mpeg', 'mpg4': 'video/mp4', 'mpga': 'audio/mpeg',
          ...
          'mpv2': 'video/mpeg2', 'mpy': 'application/vnd.ibm.minipay', 'mqy': 'application/vnd.mobius.mqy',
          'mrc': 'application/marc', 'mrcx': 'application/marcxml+xml', 'ms': 'text/troff',
          'mscml': 'application/mediaservercontrol+xml', 'mseed': 'application/vnd.fdsn.mseed',
          ...
          'pct': 'image/pict', 'pcurl': 'application/vnd.curl.pcurl', 'pcx': 'image/x-pcx',
          ...
          'pic': 'image/pict', 'pict': 'image/pict', 'pkg': 'application/octet-stream', 'pki': 'application/pkixcmp',
          'pkipath': 'application/pkix-pkipath', 'plb': 'application/vnd.3gpp.pic-bw-large',
          'plc': 'application/vnd.mobius.plc',
          'plf': 'application/vnd.pocketlearn', 'pls': 'audio/x-scpls', 'pml': 'application/vnd.ctc-posml',
          'png': 'image/png',
          'pnm': 'image/x-portable-anymap', 'pnt': 'image/x-macpaint', 'portpkg': 'application/vnd.macports.portpkg',
          ...
          's': 'text/x-asm', 's3m': 'audio/s3m', 'saf': 'application/vnd.yamaha.smaf-audio',
          ...
          'sfv': 'text/x-sfv',
          'sgi': 'image/sgi', 'sgl': 'application/vnd.stardivision.writer-global', 'sgm': 'text/sgml',
          'sgml': 'text/sgml',
          ...
          'sm': 'application/vnd.stepmania.stepchart', 'smf': 'application/vnd.stardivision.math',
          ...
          'srx': 'application/sparql-results+xml', 'ssdl': 'application/ssdl+xml',
          ...
          'stw': 'application/vnd.sun.xml.writer.template', 'sub': 'text/vnd.dvb.subtitle',
          ...
          'tfm': 'application/x-tex-tfm', 'tga': 'image/x-tga', 'thmx': 'application/vnd.ms-officetheme',
          'tif': 'image/tiff',
          ...
          'ufdl': 'application/vnd.ufdl', 'ulw': 'audio/basic', 'ulx': 'application/x-glulx',
          'umj': 'application/vnd.umajin',
          'unityweb': 'application/vnd.unity', 'uoml': 'application/vnd.uoml+xml', 'uri': 'text/uri-list',
          'uris': 'text/uri-list', 'urls': 'text/uri-list', 'ustar': 'application/x-ustar',
          ...
          'vcd': 'application/x-cdlink', 'vcf': 'text/x-vcard', 'vcg': 'application/vnd.groove-vcard',
          'vcs': 'text/x-vcalendar',
          'vcx': 'application/vnd.vcx', 'vis': 'application/vnd.visionary', 'viv': 'video/vnd.vivo',
          'vob': 'video/x-ms-vob',
          ...
          'vxml': 'application/voicexml+xml', 'w3d': 'application/x-director', 'wad': 'application/x-doom',
          'wav': 'audio/x-wav',
          ...
          'wmz': 'application/x-msmetafile', 'woff': 'application/x-font-woff', 'wpd': 'application/vnd.wordperfect',
          'wpl': 'application/vnd.ms-wpl', 'wps': 'application/vnd.ms-works', 'wqd': 'application/vnd.wqd',
          'wri': 'application/x-mswrite', 'wrl': 'model/vrml', 'wsdl': 'application/wsdl+xml',
          'wspolicy': 'application/wspolicy+xml', 'wtb': 'application/vnd.webturbo', 'wvx': 'video/x-ms-wvx',
          'x32': 'application/x-authorware-bin', 'x3d': 'model/x3d+xml', 'x3db': 'model/x3d+binary',
          ...
          'xyz': 'chemical/x-xyz',
          'xz': 'application/x-xz', 'yang': 'application/yang', 'yin': 'application/yin+xml',
          'z': 'application/x-compress',
          'Z': 'application/x-compress', 'z1': 'application/x-zmachine', 'z2': 'application/x-zmachine',
          'z3': 'application/x-zmachine', 'z4': 'application/x-zmachine', 'z5': 'application/x-zmachine',
          'z6': 'application/x-zmachine', 'z7': 'application/x-zmachine', 'z8': 'application/x-zmachine',
